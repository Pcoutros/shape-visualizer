 ...
 * Author: Pete Coutros
 * 
 * Purpose: This class defines a Cylinder that inherits from ThreeDimensionalShape. This class has two fields that are a 
 * measure of the radius and height of the Cylinder. These fields are used to calculate the volume of the Cylinder.
...
public class Cylinder extends ThreeDimensionalShape {
	...
	//Attributes
	private double radius;										//used to calculate volume of the cylinder
	private double height;										//used to calculate volume of the cylinder
	
	/**
	 * Constructor initializes the private fields of the class (radius and height). This constructor calls the constructor
	 * of ThreeDimensionalShape using super() and passes in the calculation for volume using the cylinder's radius and height 
	...
	public Cylinder(double radius, double height) {
		...
		super(Math.PI * Math.pow(radius, 2) * height);			//volume of a cylinder is π * r^2 * h
		this.radius = radius;
		this.height = height;
	}
	...
	/**
	 * This method is used to display the volume of the Cylinder object to the user by calling the inherited
	...
	protected ImageIcon getImage(int firstParameter, int secondParameter) {
		...
		ImageIcon cylinder = new ImageIcon(getClass().getResource("Images/Cylinder.png"));
		Image scaledImage = cylinder.getImage().getScaledInstance(300/firstScalingFactor, 300/secondScalingFactor, Image.SCALE_SMOOTH);
		cylinder = new ImageIcon(scaledImage);
		return cylinder;
	}
}
